...
typedef ReorderItemCallback = bool Function(Key draggedItem, Key newPosition);
...
class YdReorderableList extends StatefulWidget {
  const YdReorderableList({
    super.key,
    required this.child,
  ...
  @override
  State<StatefulWidget> createState() => _YdReorderableListState();
}
...
class ReorderableListener extends StatelessWidget {
  ...
  void _startDragging({required BuildContext context, PointerEvent? event}) {
    ...
    final listState = _YdReorderableListState.of(context)!;
...
class _YdReorderableListState extends State<YdReorderableList>
  ...
  static _YdReorderableListState? of(BuildContext context) {
    return context.findAncestorStateOfType<_YdReorderableListState>();
  }
...
class _ReorderableItemState extends State<YdReorderableItem> {
  get key => widget.key;

  @override
  Widget build(BuildContext context) {
    // super.build(context);
    _listState = _YdReorderableListState.of(context);
  ...
  @override
  void didUpdateWidget(YdReorderableItem oldWidget) {
  ...
  _YdReorderableListState? _listState;
}
...
class _DragProxyState extends State<_DragProxy> {
  ...
  void setWidget(Widget widget, RenderBox position) {
    setState(() {
      ...
      _widget = widget;
      final state = _YdReorderableListState.of(context)!;
  ...
  @override
  void deactivate() {
    _YdReorderableListState.of(context)?._dragProxy = null;
    super.deactivate();
  }
}
